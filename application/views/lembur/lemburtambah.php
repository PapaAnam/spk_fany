            ...
            <div class="col-md-7">
              ...
              <div class="col-md-12">
                <div class="form-group form-animate-text">
                  <input type="text" class="form-text dateAnimate" name="tgl_lembur" required value="<?= tglskrng() ?>">
                  <span class="bar"></span>
                  <label>Tanggal</label>
                </div>
              </div>
              <div class="col-md-12">
                <div class="form-group form-animate-text">
                  <input type="text" maxlength="4" onkeydown="typelamalembur(event)" id="lamalembur" class="form-text" name="lama_lembur" required >
                  <span class="bar"></span>
              ...
              <div class="col-md-12">
                <div class="form-group form-animate-text">
                  <textarea class="form-text" name="keterangan_lembur" required ></textarea>
                  <span class="bar"></span>
